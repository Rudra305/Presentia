...
export default function NewTeacherScreen() {
  return (
    <SafeAreaView className="flex-1 bg-bg" edges={['left', 'right', 'bottom']} testID="teacher-new">
      <ScrollView
      ...
      >
        ...
        <Text variant="bodySm" tone="muted">
          Create a teacher account. They&apos;ll set their PIN and biometric on first sign-in.
        </Text>
